...
def main():
    # atajo de teclas para alternar a la página del sudoku
    pyautogui.hotkey("alt", "tab", interval=0.1)
    # captura la pantalla para detectar el sudoku y procesarlo
